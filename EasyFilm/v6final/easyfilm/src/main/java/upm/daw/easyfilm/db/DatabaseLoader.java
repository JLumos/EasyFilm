...
/**
 * <b>Clase DatabaseLoader</b>
 * Esta clase se encarga del arranque de la base de datos.
 */
@Component
public class DatabaseLoader {
    ...
    private void initDatabase() {
        //Declaracion e Insercion de usuarios
        ...
        u20.setUser("mario");
        u20.setEmail("mario@easyfilm.com");
        u20.setPassword("mario");
        u20.setNombre("Mario");
        ...
        u22.setUser("usutest");
        u22.setEmail("test@easyfilm.com");
        u22.setPassword("test");
        u22.setNombre("Test Usabilidad");
        u22.setRoles(Arrays.asList(userRoles));
        ...
        admin.setUser("admin");
        admin.setEmail("admin@easyfilm.com");
        ...
        //Declaracion e Insercion de peliculas
        ...
        p3.setNombrePelicula("Perdona si te llamo Amor");
        p3.setUrl_portada("https://images-na.ssl-images-amazon.com/images/M/MV5BODJiNzNmZWMtOWYwNi00MDgwLTgxZGItY2Q1NjUzZGI1ZjMxL2ltYWdlXkEyXkFqcGdeQXVyMzkwMTMxNDQ@._V1_SX300.jpg");
        p3.setDescripcion("A SUCCESSFUL, ATTRACTIVE, INTELLIGENT AND BRILLIANT ADVERTISING EXECUTIVE IS LONGING TO FINALLY FIND EMOTIONAL STABILITY IN HIS LIFE, AND DECIDES TO PROPOSE TO HIS GIRLFRIEND. AFTER SHE ...");
        p3.setUrl_trailer("https://www.youtube-nocookie.com/embed/KyxQFrIdRAQ");
